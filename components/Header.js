    ...
    return (
        <section ref={ref} id='home' className={styles.parent}>
            ...
            <div className={styles.headImage}>
                <Image src='/../public/assets/images/headImage.jpg' style={{width:'auto', height:'auto'}} priority={true} width={mediaMatch ? '500' : '300'} height={mediaMatch ? '500' : '300'} alt='Hero Image'/>
            </div>
        </section>
