    ...
    return (
        <section ref={ref} id='home' className={styles.parent}>
            ...
            <div className={styles.headImage}>
                <Image src={props.mode=='dark'?'/../public/assets/images/header.jpg':'/../public/assets/images/headerlight.jpg'} style={{width:mediaMatch?'500':'300', height:mediaMatch?'500':'300'}} priority={true} width={mediaMatch ? '450' : '300'} height={mediaMatch ? '450' : '300'} alt='Hero Image'/>
            </div>
        </section>
    )
})
