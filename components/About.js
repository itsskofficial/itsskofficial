    ...
    return (
        <section data-aos='fade-in' ref={ref} id='about' className={styles.parent}>
            <div className={styles.aboutImage}>
                <Image src={props.mode == 'dark' ? '/public/assets/images/about.jpg' : '/assets/images/aboutlight.jpg'} width={mediaMatch?'450':'300'} height={mediaMatch?'450':'300'} alt='About Image' />
            </div>
