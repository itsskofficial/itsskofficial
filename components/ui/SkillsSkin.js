...
const SkillsSkin = (props) => {
    ...
    const codeIcons = (
        <Fragment>
            <div className={styles.skillsSkinRow} style={colo}>
                <i className={`fa-brands fa-python fa-${mediaMatch?'3x':'2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
                <i className={`fa-brands fa-js fa-${mediaMatch?'3x':'2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
                <i className={`fa-brands fa-c fa-${mediaMatch?'3x':'2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
                <Image src='/assets/images/cpp.svg' width={mediaMatch?'60':'30'} height={mediaMatch?'60':'30'} alt='C++ Icon'/>
                <i className={`fa-brands fa-html5 fa-${mediaMatch ? '3x' : '2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
            </div>
            <div className={styles.skillsSkinRow} >
                <i className={`fa-brands fa-css3 fa-${mediaMatch?'3x':'2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
                <i className={`fa-brands fa-react fa-${mediaMatch?'3x':'2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
                <i className={`fa-brands fa-node fa-${mediaMatch ? '3x' : '2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
            ...
            <div className = {styles.skillsSkinRow } >
                ...
                <i className={`fa-brands fa-ethereum fa-${mediaMatch ? '3x' : '2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
            </div>
            <div className = {styles.skillsSkinRow } >
    ...
    const toolsIcons = (
        <Fragment>
            <div className = {styles.skillsSkinRow }>
                <i className={`fa-brands fa-figma fa-${mediaMatch ? '3x' : '2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
            ...
            <div className={styles.skillsSkinRow}>
                ...
                <i className={`fa-brands fa-slack fa-${mediaMatch ? '3x' : '2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
                <i className={`fa-brands fa-jira fa-${mediaMatch ? '3x' : '2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
                <i className={`fa-brands fa-confluence fa-${mediaMatch ? '3x' : '2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
            </div>
            <div className={styles.skillsSkinRow}>
                <i className={`fa-brands fa-wordpress fa-${mediaMatch ? '3x' : '2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
                ...
                <i className={`fa-brands fa-github fa-${mediaMatch ? '3x' : '2x'}`} style={{color:props.mode=='dark'?null: '#171717'}}/>
            </div>
            {/* <div className={styles.skillsSkinRow}>
