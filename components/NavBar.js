...
const NavBar = (props) => {
    ...
    const burgerMenuClassesLight = ['bm-burger-button-light', 'bm-burger-bars-light', 'bm-burger-bars-hover-light', 'bm-cross-button-light', 'bm-cross-light', 'bm-menu-wrap-light','bm-morph-shape-light', 'bm-item-list-light', 'bm-item-light', 'bm-overlay-light'].join(' ')
    ...
    const smallScreen = (
        <section className={props.mode=='dark'?styles.parent:styles.parentLight}>
            ...
            <Menu className={[burgerMenuClasses,props.mode=='dark'?burgerMenuClasses:burgerMenuClassesLight} right width={150} isOpen={isMenuOpen} onStateChange={handleMenuChange}>
                {navlinks.map(link => {
                    return (
