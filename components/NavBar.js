...
const NavBar = (props) => {
    ...
    const burgerMenuClassesLight = [swtyles.bm-burger-button, styles.bm-burger-bars, styles.bm-burger-bars-hover, bm-cross-button', 'bm-cross','bm-menu-wrap','bm-morph-shape', 'bm-item-list', 'bm-item', 'bm-overlay']
