...
const NavBar = (props) => {
    ...
    const burgerMenuClassesLight = [swtyles.bm-burger-button, styles.bm-burger-bars, styles.bm-burger-bars-hover, styles.bm-cross-button, styles.bm-cross,styles.bm-menu-wrap,styles.bm-morph-shape, styles.bm-item-list, styles.bm-item, styles.bm-overlay]
