...
const NavBar = (props) => {
    ...
    const burgerMenuClassesLight = [bm-burger-button, bm-burger-bars, 'bm-burger-bars-hover-', 'bm-cross-button', 'bm-cross', 'bm-menu-wrap','bm-morph-shape', 'bm-item-list', 'bm-item', 'bm-overlay'].join(' ')
