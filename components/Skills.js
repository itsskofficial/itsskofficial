        ...
        <section data-aos='fade-in' ref={ref} id='skills' className={styles.parent}>
            <div className={styles.skillsText}>
                ...
                <div className={styles.skillsToggle}>
                    ...
                    <button className={[props.mode=='dark'?styles.skillsTools:styles.skillsToolsLight,skillsOption=='code'?props.mode=='dark'?styles.skillsActiveButton:styles.skillsActiveButtonLight:null].join(' ')} onClick={() => {
